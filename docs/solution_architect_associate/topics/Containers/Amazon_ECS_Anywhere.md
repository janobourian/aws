...
```
7. Log in to your local Linux server (virtual or physical) and execute the command.
8. Once completed, verify the server appears as an active container instance in the **ECS Console**.
